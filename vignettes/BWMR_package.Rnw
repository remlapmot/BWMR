...
% \VignetteIndexEntry{BWMR Package for causal inference based on summary statistics}
% \VignetteDepends{BWMR}
% \VignetteKeyword{Mendelian randomization}
\usepackage{grfext}
...
\begin{figure}
\begin{center}
<<plot1, fig=TRUE, height=3, width=4>>=
fit.BWMR$plot1
@
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
<<plot2, fig=TRUE, height=3, width=4>>=
fit.BWMR$plot2
@
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
<<plot3, fig=TRUE, height=3, width=7>>=
fit.BWMR$plot3
@
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
<<plot4, fig=TRUE, height=3, width=6>>=
fit.BWMR$plot4
@
\end{center}
\end{figure}
